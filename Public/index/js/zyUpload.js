...
//		            html += '					<div class="upload_btn">开始上传</div>';
				    ...
				    html += '							<img class="upload_image" src="Public/index/img/add_img.png" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
...
//		            html += '					<div class="webuploader_pick">选择文件</div>';
		            html += '					<div class="upload_btn wechat">确认</div>';
		            html += '				</div>';
		            html += '			</div>';
					html += '		</div>';
					html += '		<div class="upload_submit">';
